...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Your Analysis is ready!",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w600,color: AppColors.textColor),),
                   ...
                   child: Column(
                      ...
                      children: [
                        Text(
                          ...
                          style:const TextStyle(fontSize: 20,fontWeight: FontWeight.w600,color: AppColors.textColor)
                        ),
                        const SizedBox(height: 4),
                        const Text("Your Latest Result",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w300,color: AppColors.textColor),),
                       ...
                       style: const TextStyle(fontSize: 18,fontWeight: FontWeight.w600,color: AppColors.textColor),
                        ...
                        const SizedBox(height: 8),
                        Text(
                          DateFormat('d MMM yyyy').format(homeVM.reports.first.testDate ?? DateTime.now()),
                       style: const TextStyle(fontSize: 14,fontWeight: FontWeight.w300,color: AppColors.textColor),
                        ...
                        SizedBox(
                          height: 200,
                          child: _buildLineChart(homeVM.reports, metric),
                        ),
                      ],
                    ),
                  ),
...
Widget _buildLineChart(List<BloodReportMetricModel> data, String metric) {
  final spots = data.asMap().entries.map((entry) {
    ...
    final value = double.tryParse(entry.value.reportMetrics[metric]?.value ?? '') ?? 0;
              ...
              if (value.toInt() >= 0 && value.toInt() < data.length) {
                ...
                return Padding(
                  ...
                  child: Text(
                    ...
                    style: const TextStyle(fontSize: 7, color: AppColors.textColor,fontWeight: FontWeight.w500),
                  ),
                );
              }
              return const Text('');
              ...
              child: Column(
                ...
                children: [
                  SkeletonLine(
                    ...
                    width: 120, height: 20, borderRadius: BorderRadius.circular(12))),
                  const SizedBox(height: 8),
                  SkeletonLine(style: SkeletonLineStyle(width: 80, height: 12, borderRadius: BorderRadius.circular(12))),
                  const SizedBox(height: 8),
                  SkeletonLine(style: SkeletonLineStyle(width: 160, height: 18, borderRadius: BorderRadius.circular(12))),
                  const SizedBox(height: 10),
                  const SkeletonAvatar(style: SkeletonAvatarStyle(height: 200, width: double.infinity)),
                ],
              ),
            ),
          );
